...
<template>
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4">
        <input :value="filters.search" @input="
            ...
            " type="text" placeholder="Search by description, category, or amount..."
            class="border rounded-lg px-4 py-2 w-full sm:flex-1 focus:ring-2 focus:ring-blue-300 focus:outline-none dark:bg-gray-200 dark:text-black" />
        <button @click="toggleFilters" :class="[
            'px-4 py-2 rounded-lg font-medium transition-colors flex items-center justify-center gap-2 w-full sm:w-auto bg-gray-300 dark:bg-gray-200',
            hasActiveFilters
    ...
    <!-- Filter Panel -->
    <div v-if="showFilters" class="bg-white dark:bg-gray-600 border rounded-lg p-4 shadow-sm space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div>
                ...
                <select :value="filters.typeFilter" @change="
                    updateFilter(
                        'typeFilter',
            ...
            <div>
                ...
                <select :value="filters.categoryFilter" @change="
                    updateFilter(
                        'categoryFilter',
                        ($event.target as HTMLSelectElement).value
                    )
            ...
            <div>
                ...
                <input :value="filters.dateFrom" @input="
                    updateFilter(
                        'dateFrom',
            ...
            <div>
                ...
                <input :value="filters.dateTo" @input="
