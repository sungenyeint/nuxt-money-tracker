      ...
      <form @submit.prevent="onUpdate" class="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            type="color"
            class="mt-2 w-full h-10 border rounded"
          />
        </div>
        <button
          type="submit"
          class="w-full py-2 bg-green-600 text-white rounded-lg font-semibold mt-2"
        >
          Update Category
        </button>
      </form>
